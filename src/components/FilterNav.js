...
//       <button className='focus:font-bold' onClick={() => filterHandler("all")} type='button'>All</button>
//       <button className='focus:font-bold' onClick={() => filterHandler("active")} type='button'>Active</button>
//       <button className='focus:font-bold' onClick={() => filterHandler("completed")} type='button'>Completed</button>
//     </div>
//   )
// }
